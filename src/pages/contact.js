    ...
    <section class="stub-page container">
      ...
      <div class="info-page__body">
        ...
        <ul>
          ...
          <li><strong>Delivery support</strong>, such as a delivery address that needs to be corrected. See our <a href="/shipping-policy">Shipping Policy</a> for the R80 delivery rule, free for registered customers from R650.</li>
